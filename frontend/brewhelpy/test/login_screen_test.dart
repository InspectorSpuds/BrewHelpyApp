...
void main() {
  testWidgets('Login screen should build its UI components correctly', (WidgetTester tester) async {
    //Arrange
  ...
  testWidgets('Login function should be called with valid inputs', (WidgetTester tester) async {
    //Arrange
    await tester.pumpWidget(const MaterialApp(home: LoginScreen()));
